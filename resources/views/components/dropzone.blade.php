<div class="relative flex items-center justify-center w-full mb-10">
    <label for="dropzone-file"
        ...
        <input type="file" id="dropzone-file" multiple
            class="absolute top-0 left-0 w-full h-full opacity-0 cursor-pointer" {{ $attributes }} />
    </label>
</div>
